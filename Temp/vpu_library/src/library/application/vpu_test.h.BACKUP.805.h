 ...
 *  --------  -------   -----------         ------
 *  24/11/15    01      Copied as it is
 *                      from mxc-test,      Shreyas
 *                      Linux
 ******************************************************************************/ 
...
>>>>>>> 57ca4da776a15e80c434ab0ee290c4c2eebd1162
// #include <linux/ipu.h>
#define COMMON_INIT
...
/*struct vpu_display { :TODO Commmented as it threw Error when compiling
  int fd;
  int nframes;
  int ncount;
  time_t sec;
...
<<<<<<< HEAD
    ...
    Uint16 complete; /* wait for the requested buf to be filled completely */
    int iframe;
    int mp4_h264Class;
